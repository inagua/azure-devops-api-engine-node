 ...
 */
class StateUpdatesForItemIdStep extends UpdatesForItemIdStep {
    ...
    async doRun$(itemId) {
        ...
        return updates.filter(u => u?.fields && !!u.fields[Fields.State]);
    }

}

module.exports.StateUpdatesForItemIdStep = StateUpdatesForItemIdStep;
